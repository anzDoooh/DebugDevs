...
public class ShapeDetection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hintText.text = "Draw a circle shape in a paper and upload it.This shape is round like a wheel or a cookie. It rolls smoothly and has no corners.";
        resultText.text = "";
    }
    ...
    IEnumerator ProcessImageCoroutine()
    {
        ...
        string serverUrl = "http://127.0.0.1:5000/process"; // Replace with your actual server URL
        ...
        else
        {
            ...
            {
                resultText.text = "Correct! This is a circle.";
