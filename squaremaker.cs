...
public class squaremaker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hintText.text = "Draw a square shape in a paper and upload it.This shape has four equal sides and four corners. It looks like a cream cracker biscuits or a tile.";
        resultText.text = "";
    }
    ...
    IEnumerator ProcessImageCoroutine()
    {
        ...
        string serverUrl = "http://127.0.0.1:8080/process"; // Replace with your actual server URL
        ...
        else
        {
            ...
            {
                resultText.text = "Correct! This is a square.";
